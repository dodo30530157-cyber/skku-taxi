...
.bg-\[\#0047FF\]\/5 {
  background-color: rgb(0 71 255 / 0.05);
}
.bg-\[\#181919\] {
  --tw-bg-opacity: 1;
...
.focus-within\:ring-\[\#2563EB\]:focus-within {
  --tw-ring-opacity: 1;
...
.hover\:border-\[\#0047FF\]\/40:hover {
  border-color: rgb(0 71 255 / 0.4);
}
...
.hover\:bg-\[\#003DDB\]:hover {
  --tw-bg-opacity: 1;
  background-color: rgb(0 61 219 / var(--tw-bg-opacity, 1));
}

.hover\:bg-\[\#0047FF\]\/10:hover {
  background-color: rgb(0 71 255 / 0.1);
}

.hover\:bg-\[\#0047FF\]\/20:hover {
  background-color: rgb(0 71 255 / 0.2);
}

.hover\:bg-\[\#0047FF\]\/90:hover {
  background-color: rgb(0 71 255 / 0.9);
}
...
.hover\:bg-\[\#2563EB\]\/20:hover {
  background-color: rgb(37 99 235 / 0.2);
}

.hover\:bg-\[\#2563EB\]\/5:hover {
  background-color: rgb(37 99 235 / 0.05);
}
...
.hover\:text-\[\#003DDB\]:hover {
  --tw-text-opacity: 1;
  color: rgb(0 61 219 / var(--tw-text-opacity, 1));
}
...
.focus\:ring-\[\#0047FF\]:focus {
  --tw-ring-opacity: 1;
  --tw-ring-color: rgb(0 71 255 / var(--tw-ring-opacity, 1));
}

.focus\:ring-\[\#0047FF\]\/15:focus {
  --tw-ring-color: rgb(0 71 255 / 0.15);
}
...
.focus\:ring-\[\#2563EB\]\/20:focus {
  --tw-ring-color: rgb(37 99 235 / 0.2);
}

.focus\:ring-\[\#2563EB\]\/50:focus {
...
.group:hover .group-hover\:bg-\[\#1D4ED8\] {
  --tw-bg-opacity: 1;
  background-color: rgb(29 78 216 / var(--tw-bg-opacity, 1));
}
...
.group:hover .group-hover\:ring-\[\#2563EB\] {
  --tw-ring-opacity: 1;
  --tw-ring-color: rgb(37 99 235 / var(--tw-ring-opacity, 1));
}
